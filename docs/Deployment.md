...
| `src\CampanulaTasksFlow` | Generated by GitHub Copilot during repo initialization. | Legacy prototype; do not use as the implementation source for `CampanulaPlannerFlows`. |
...
prototype. Do not copy from it when building `CampanulaPlannerFlows`.
